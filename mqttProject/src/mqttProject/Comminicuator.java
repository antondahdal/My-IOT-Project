...
public class Comminicuator implements MqttCallbackExtended {
	private String brokerUrl="tcp://iot.beaconyun.com:1883";
		 ...
		 for(int i=0;i<dataJsonArr.size();i++) {
			...
			if(deviceType.equals("Unknown")) {
				 ...
				 if(AccData.isAccelerometerRawData(rawData)) {
					 walkClass walkdata=new walkClass(mac,TS);
...
public void connectionLost(Throwable arg0) {
	...
	System.out.print("Connection Lost  "+arg0);
	}
...
public void messageArrived(String topic, MqttMessage message) throws Exception {
	...
	List<EnvData>list=parseData(data);
